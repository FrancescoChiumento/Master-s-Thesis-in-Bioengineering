...
def register_moving_images_function(base_dir):
    ...
    for moving_image_path in moving_files_path:
        ...
        transform_parameters_file0_fase1 = os.path.join(fase1_femur_folder, "TransformParameters.0.txt")
        transform_parameters_file1_fase1 = os.path.join(fase1_femur_folder, "TransformParameters.1.txt")
        transform_parameters_file2_fase1 = os.path.join(fase1_femur_folder, "TransformParameters.2.txt")

        transform_parameters_file0_fase2 = os.path.join(fase2_cartilage_folder, "TransformParameters.0.txt")
        transform_parameters_file1_fase2 = os.path.join(fase2_cartilage_folder, "TransformParameters.1.txt")
    ...
    # transform_parameters_file0_fase1,
    # transform_parameters_file1_fase1,
        transform_parameters_file2_fase1, 
    #   transform_parameters_file0_fase2,
    # transform_parameters_file1_fase2,
